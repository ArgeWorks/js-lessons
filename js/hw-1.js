...
//4)
console.log(`Положение второго пробела : ${str.indexOf(' ') + 1}`);

//5)
console.log(`Получить строку с 5-го символа длиной 4 буквы: ${str.substr(4, 4)}`);

//6)
console.log(`Получить строку с 5-го по 9-й символ: ${str.substring(4, 8)}`);
...
//4)
console.log(`1 Вариант) Результат вычисления 0.6 + 0.7 = ${(0.6 + 0.7).toFixed(1)}`);
console.log(`2 Вариант) Результат вычисления 0.6 + 0.7 = ${(0.6 * 10 + 0.7 * 10) / 10}`);
